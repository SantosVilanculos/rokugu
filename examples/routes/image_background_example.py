...
from rokugu.widgets.image_background import ImageBackground


class ImageBackgroundExample(ImageBackground):
    def __init__(self) -> None:
        ...
        self._q_combo_box.addItem("Contain", ImageBackground.ObjectFit.Contain)
        self._q_combo_box.addItem("Cover", ImageBackground.ObjectFit.Cover)
        self._q_combo_box.addItem("Fill", ImageBackground.ObjectFit.Fill)
        self._q_combo_box.addItem(
            "Scale down", ImageBackground.ObjectFit.ScaleDown
        )
        self._q_combo_box.addItem("Unset", ImageBackground.ObjectFit.Unset)
